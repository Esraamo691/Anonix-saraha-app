...
//             In less than 6 months, we’ll make sure you never need to hire an
//             agency, depend on paid ads, or pay an influencer again.
//           </p>

//           <p className="relative z-10 mt-2 text-sm text-gray-400">
//             You’ll be the voice. You’ll be the strategy. You’ll be the brand.
//           </p>
//         </div>
//       </section>
//     </>
