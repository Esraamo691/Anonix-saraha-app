      ...
      <section className="relative bg-[#070a10] min-h-screen flex justify-center items-center overflow-hidden">
        <div className="relative mx-auto max-w-5xl text-center text-white">
          ...
          <motion.h1
            ...
            className="relative z-10 font-serif text-6xl leading-tight md:text-8xl"
          >
            ANONIX
          </motion.h1>
          ...
          <motion.p
            ...
            className="relative z-10 mx-auto mt-6 max-w-xl text-sm text-gray-300"
          >
          ...
          <motion.p
            ...
            className="relative z-10 mt-2 text-sm text-gray-400"
          >
